...
|*ISO/IEC 25010*|Performance Efficiency – Capacity; Reliability – Fault Tolerance
|*AWS Well-Architected Framework*|PERF 2 – How do you select and use scaling mechanisms?; REL 6 – How do you monitor workload resources?
|*Azure Well-Architected Framework*|Performance Efficiency – Design for scaling; Reliability – Use automatic scaling
|*Google Cloud Architecture Framework*|Performance optimization – Use autoscaling; id: waf-perf-020.tf.aws.autoscaling-group-policy; aws_autoscaling_group; id: waf-perf-020.tf.azurerm.vmss-autoscale; azurerm_monitor_autoscale_setting; id: waf-perf-020.tf.google.managed-instance-group-autoscaler; google_compute_autoscaler; google_compute_region_autoscaler
