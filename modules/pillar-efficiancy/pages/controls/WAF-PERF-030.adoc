...
|*AWS Well-Architected Framework*|PERF 3 – How do you select your storage solution?; PERF 4 – How do you select your database solution?
|*Azure Well-Architected Framework*|Performance Efficiency – Use caching
|*TOGAF*|Architecture Building Blocks – Caching Services; id: waf-perf-030.tf.aws.elasticache-cluster-configured; aws_elasticache_replication_group; aws_elasticache_cluster; id: waf-perf-030.tf.azurerm.redis-cache-premium; azurerm_redis_cache; id: waf-perf-030.tf.google.memorystore-redis-ha; google_redis_instance
