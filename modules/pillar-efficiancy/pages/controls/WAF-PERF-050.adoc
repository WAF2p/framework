...
|*AWS Well-Architected Framework*|OPS 7 – How do you know that your workload and changes are successful?; REL 9 – How do you test reliability?
|*Google SRE Book*|Service Level Objectives; Error Budgets
|*ITIL 4*|Service Level Management; id: waf-perf-050.tf.aws.cloudwatch-latency-alarm; aws_cloudwatch_metric_alarm; id: waf-perf-050.tf.azurerm.app-insights-availability; azurerm_application_insights; id: waf-perf-050.tf.google.monitoring-uptime-check; google_monitoring_alert_policy
