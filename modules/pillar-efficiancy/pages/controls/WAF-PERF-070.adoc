...
|*AWS Well-Architected Framework*|PERF 3 – How do you select your networking solution?; COST 9 – How do you manage demand and supply resources?
|*Azure Well-Architected Framework*|Performance Efficiency – Optimize network performance
|*Google Cloud Architecture Framework*|Network design – Optimize for latency; id: waf-perf-070.tf.aws.vpc-endpoint-s3; aws_vpc_endpoint; id: waf-perf-070.tf.azurerm.cdn-profile-configured; azurerm_cdn_profile; azurerm_frontdoor; azurerm_cdn_frontdoor_profile; id: waf-perf-070.tf.google.cloud-cdn-enabled; google_compute_backend_service
