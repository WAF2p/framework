...
|*ISO/IEC 12207*|Software Maintenance – Risk Management
|*ITIL 4*|Service Level Management – Continual Improvement
|*DORA*|Continuous improvement – Technical debt management; id: waf-perf-100.tf.aws.config-performance-rules; aws_config_config_rule; id: waf-perf-100.tf.azurerm.policy-performance-governance; azurerm_resource_group_policy_assignment; azurerm_subscription_policy_assignment; id: waf-perf-100.tf.google.security-health-analytics; google_scc_notification_config
