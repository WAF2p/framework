...
|*AWS Well-Architected Framework*|PERF 1 – How do you select the best performing architecture?; COST 8 – How do you use managed services to improve efficiency?
|*Azure Well-Architected Framework*|Performance Efficiency – Use platform-as-a-service
|*Google Cloud Architecture Framework*|Managed services – Use fully managed services where possible; id: waf-perf-080.tf.aws.lambda-memory-timeout-configured; aws_lambda_function; id: waf-perf-080.tf.azurerm.function-app-plan-configured; azurerm_service_plan; id: waf-perf-080.tf.google.cloud-run-min-instances; google_cloud_run_service; google_cloud_run_v2_service
