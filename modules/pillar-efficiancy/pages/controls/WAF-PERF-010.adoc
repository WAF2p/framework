...
|* ISO/IEC 25010* | Performance Efficiency – Time Behavior; Performance Efficiency – Resource Utilization; Performance Efficiency – Capacity
|* AWS Well-Architected Framework* | Performance Efficiency Pillar – Select the right resource types and sizes; PERF 1 – How do you select the best performing architecture?
|* Azure Well-Architected Framework* | Performance Efficiency – Choose the right resources
|* Google Cloud Architecture Framework* | Performance optimization – Right-size your instances; id: waf-perf-010.tf.aws.ec2-current-generation; aws_instance; aws_launch_template; aws_launch_configuration; id: waf-perf-010.tf.azurerm.vm-sizing-documented; azurerm_linux_virtual_machine; azurerm_windows_virtual_machine; azurerm_virtual_machine_scale_set; id: waf-perf-010.tf.google.gce-machine-type-validated; google_compute_instance; google_compute_instance_template
