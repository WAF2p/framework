= Architektur
:description: Referenzmodelle, Reifegrad und Entscheidungsleitfäden
...
Diese Leitfäden sollen als *Fragenkatalog* und *Scoring-Sheets* verfügbar werden, um Architekt:innen durch den Entscheidungsprozess zu führen.
