= Controls (WAF-SOV)
:page-toc: right
:description: WAF++ – Controls Catalog for the Sovereign Pillar (WAF-SOV-010 to WAF-SOV-100).

The Sovereign pillar is operationalized through 10 measurable controls.
Each control has a unique ID in the format `WAF-SOV-NNN`, a severity classification,
machine-readable YAML checks, and a maturity level.

The YAML source files are located under `modules/controls/controls/WAF-SOV-*.yml`
and can be executed directly by the WAF++ checker tool.

== Regulatory Framework Mapping

The WAF++ Sovereign controls are mapped to multiple regulatory frameworks:
...
|All 10 controls mapped. Covers the 7 dimensions:
Strategic (jurisdiction), Legal & Jurisdictional, State of Defense Takeover,
Data (residency, encryption), Operational (SOC, personnel),
Supply Chain (inventory), Technology (source code backup).

|*BSI C5:2020* (Cloud Computing Security Basline)
|All 10 controls mapped; foundational security requirements.

|*GDPR* (General Data Protection Regulation)
|All 10 controls mapped; Art. 32 (security), Art. 44-46 (transfers),
Art. 28 (processors), Art. 17 (erasure), Art. 20 (portability).

|*EUCS* (EU Cybersecurity Scheme for Cloud Services)
|All 10 controls mapped; ENISA standards for EU cloud services.

|*ISO 27001:2022*
|All 10 controls mapped; A.5.x (security), A.8.x (operations) families.

|*GAIA-X*
|All 10 controls mapped; Sovereign Cloud principles and interoperability.
