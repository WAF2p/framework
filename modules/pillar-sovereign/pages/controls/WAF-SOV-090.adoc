...
|* BSI C3A:2026*
|Dimension 5 – Operational: Network security and monitoring; Dimension 5 – Operational: Disconnect and reconnect capability
...
|* GDPR* | Art. 32 – Security of processing (network security); Art. 44-46 – Transfers to third countries
|* BSI C5:2020* | SIM-02 – Intrusion detection; OPS-04 – Data management; NET-01 – Network security
|* BSI C3A:2026* | Dimension 5 – Operational: Network security and monitoring; Dimension 5 – Operational: Disconnect and reconnect capability
|* EUCS (ENISA)* | IVS-09 – Network security; IVS-10 – Egress filtering
|* ISO 27001:2022* | A.8.20 – Networks security; A.8.21 – Security of network services; A.8.22 – Segregation of networks; id: waf-sov-090.tf.aws.no-unrestricted-egress; aws_security_group_rule; aws_security_group; id: waf-sov-090.tf.aws.vpc-endpoint-s3; aws_vpc; id: waf-sov-090.tf.aws.vpc-flow-logs-enabled; aws_vpc; id: waf-sov-090.tf.aws.network-acl-no-open-egress; aws_network_acl_rule; id: waf-sov-090.tf.azurerm.nsg-no-open-outbound; azurerm_network_security_rule
