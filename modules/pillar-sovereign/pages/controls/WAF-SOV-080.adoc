...
|*GDPR*|Art. 28 – Processor; Art. 30 – Records of processing activities; Art. 44-46 – Transfers to third countries
|*BSI C5:2020*|SCA-01 – Supply chain management; OPS-04 – Data management
|*BSI C3A:2026*|Dimension 6 – Supply Chain: Software inventory (SBoM); Dimension 6 – Supply Chain: Hardware inventory; Dimension 6 – Supply Chain: External service dependencies
|*EUCS (ENISA)*|SCA-01 – Supply chain; IAM-04 – Third-party access
|*ISO 27001:2022*|A.5.19 – Information security in supplier relationships; A.5.20 – Addressing information security in supplier agreements; A.5.21 – Managing information security in the ICT supply chain
|*SLSA*|L2 – Build integrity; L3 – Source integrity; id: waf-sov-080.tf.any.required-providers-version-pinned; id: waf-sov-080.tf.any.required-terraform-version; id: waf-sov-080.tf.any.module-source-version-pinned; id: waf-sov-080.tf.any.no-untrusted-registry-modules
