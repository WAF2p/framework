...
|*BSI C3A:2026*
|Dimension 7 – Technology: Source code backup and recovery; Dimension 7 – Technology: EU-based backups within 24 hours
...
|*GDPR*|Art. 17 – Right to erasure (must be able to delete data); Art. 20 – Right to data portability; Art. 28 – Processor obligations including data return/deletion on termination
|*BSI C5:2020*|PRO-01 – Portability and interoperability; OPS-06 – Exit management
|*BSI C3A:2026*|Dimension 7 – Technology: Source code backup and recovery; Dimension 7 – Technology: EU-based backups within 24 hours
|*EUCS (ENISA)*|PRO-01 – Portability; PRO-02 – Interoperability
|*GAIA-X*|Sovereign Cloud – Reversibility requirements
|*ISO 27001:2022*|A.5.20 – Addressing information security in supplier agreements (including exit); A.8.10 – Information deletion; id: waf-sov-100.tf.aws.s3-lifecycle-policy-defined; aws_s3_bucket; id: waf-sov-100.tf.aws.s3-versioning-for-data-portability; aws_s3_bucket_versioning; id: waf-sov-100.tf.any.resource-tag-portability; aws_s3_bucket; aws_rds_instance; aws_rds_cluster; aws_dynamodb_table; azurerm_storage_account; azurerm_sql_database; google_storage_bucket; google_sql_database_instance; id: waf-sov-100.tf.any.no-proprietary-lock-in-patterns; aws_cloudsearch_domain; aws_mq_broker; aws_redshift_cluster; id: waf-sov-100.tf.aws.rds-deletion-protection; aws_db_instance; aws_rds_cluster
