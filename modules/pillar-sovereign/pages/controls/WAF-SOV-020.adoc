...
|*GDPR*|Art. 44 – General principle for transfers; Art. 46 – Transfers to third countries
|*BSI C5:2020*|OPS-04 – Data management; INF-01 – Physical location
|*BSI C3A:2026*|Dimension 4 – Data: Location of data processing; Dimension 1 – Strategic: Jurisdictional alignment
|*EUCS (ENISA)*|SOV-01 – Data location; SOV-02 – Jurisdiction control
|*GAIA-X*|Data Sovereignty – Location transparency
|*ISO 27001:2022*|A.8.10 – Information deletion; A.5.29 – Information security during disruption; id: waf-sov-020.tf.aws.provider-region-in-allowed-list; id: waf-sov-020.tf.aws.region-variable-validation; id: waf-sov-020.tf.azurerm.location-variable-validation; id: waf-sov-020.tf.google.region-variable-validation; id: waf-sov-020.tf.aws.no-hardcoded-non-sovereign-region
