...
|* GDPR* | Art. 5(1)(e) – Storage limitation; Art. 32 – Security of processing (availability and resilience); Art. 44-46 – Transfers to third countries
|* BSI C5:2020* | OPS-04 – Data management; BCM-01 – Business continuity
|* BSI C3A:2026* | Dimension 4 – Data: Backup location and residency; Dimension 6 – Supply Chain: Backup provider inventory
|* EUCS (ENISA)* | BCR-01 – Backup policy; DSP-04 – Data portability
|* ISO 27001:2022* | A.8.13 – Information backup; A.5.29 – Information security during disruption; id: waf-sov-030.tf.aws.db-instance-backup-retention; aws_db_instance; id: waf-sov-030.tf.aws.rds-cluster-backup-retention; aws_rds_cluster; id: waf-sov-030.tf.aws.dynamodb-pitr-enabled; aws_dynamodb_table; id: waf-sov-030.tf.aws.backup-vault-in-approved-region; aws_backup_plan; id: waf-sov-030.tf.azurerm.recovery-vault-location; azurerm_recovery_services_vault; id: waf-sov-030.tf.aws.s3-versioning-enabled; aws_s3_bucket_versioning
