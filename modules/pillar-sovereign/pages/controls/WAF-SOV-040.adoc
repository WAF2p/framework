...
|*BSI C3A:2026*
|Dimension 5 – Operational: Logging and monitoring location; Dimension 5 – Operational: SOC (Security Operations Center)
...
---
=== waf-sov-040.tf.stackit.logging-region-sovereign
*Checks:* StackIT logging must be stored in sovereign regions.

*Supported providers:* **StackIT**

---
=== waf-sov-040.tf.ovh.logging-region-sovereign
*Checks:* OVH logging must be stored in sovereign regions.

*Supported providers:* **OVH**

---
=== waf-sov-040.tf.hcloud.logging-region-sovereign
*Checks:* Hetzner Cloud logging must be stored in sovereign regions.
