...
---
=== waf-sov-050.tf.stackit.key-rotation-enabled
*Checks:* StackIT Secret Manager keys must have automatic rotation enabled.
...
---
=== waf-sov-050.tf.ovh.key-rotation-enabled
*Checks:* OVH secret manager keys must have rotation configured.

---
=== waf-sov-050.tf.hcloud.key-rotation-enabled
*Checks:* Hetzner Cloud secret store keys must have rotation configured.
