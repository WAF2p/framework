...
|*ISO 27001:2022*
|A.8.2 – Privileged access rights; A.8.5 – Secure authentication; A.5.17 – Authentication information; A.5.15 – Access control

|*ISO 27017*
|CLD.9.5 – Segregation in virtual computing environments

|*CIS Controls v8*
|CIS 5 – Account Management; CIS 6 – Access Control Management

|*CSA STAR*
|CCM IAM-01 – Identity and Access Management Policy; CCM IAM-02 – Strong Password Policy and Procedures

|*PCI DSS v4.0*
|Req 7 – Restrict access by business need to know; Req 8 – Identify and authenticate access

|*SOC 2 Type II*
|CC6.1 – Logical and physical access controls; CC6.2 – Provisioning and removal of access; CC6.3 – Authentication mechanisms
...
|*BSI C5:2020*
|IDM-01 – Identity and access management policy; IDM-02 – Authentication of users; IDM-09 – Privileged access rights
...
|*NIST SP 800-53*
|AC-2 – Account Management; IA-2 – Identification and Authentication; IA-5 – Authenticator Management

|*NIST CSF 2.0*
|PR.AA-01 – Identities and credentials are managed; PR.AA-03 – Users, services and hardware are authenticated

|*FedRAMP*
|AC-2, IA-2, IA-5 (Moderate/High baseline)

|*CMMC 2.0*
|AC.L2-3.1.1 – Limit system access to authorized users; IA.L2-3.5.3 – Multifactor authentication

|*ASD Essential 8*
|E8.5 – Restrict administrative privileges; E8.7 – Multi-factor authentication

|*IRAP*
|ISM – Identification and authentication

|*CCCS PBMM*
|AC-2, IA-2, IA-5 – Account and authenticator management
