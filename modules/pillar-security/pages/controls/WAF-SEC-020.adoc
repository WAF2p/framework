...
|*ISO 27001:2022*
|A.8.2 – Privileged access rights; A.8.3 – Information access restriction; A.5.15 – Access control; A.5.18 – Access rights
...
|*CSA STAR*
|CCM IAM-09 – User Access Authorization; CCM IAM-10 – User Access Reviews

|*PCI DSS v4.0*
|Req 7.2 – Establish access based on least privilege

|*SOC 2 Type II*
|CC6.1 – Logical access security; CC6.3 – Authorisation and segregation of duties

|*COBIT 2019*
|DSS05.04 – Manage user identity and logical access

|*GDPR*
|Art. 32 – Security of processing; Art. 5(1)(f) – Integrity and confidentiality; Art. 25 – Data protection by design

|*NIS2*
|Art. 21(2)(i) – Access control measures

|*DORA*
|Art. 9 – Protection and prevention

|*EUCS (ENISA)*
|IAM-01 – Identity and access management; IAM-03 – Least privilege access control

|*BSI C5:2020*
|IDM-01 – Identity and access management policy; IDM-03 – Access control and authorisation; IDM-09 – Privileged access management
...
|*ENS High*
|op.acc.4 – Proceso de gestión de derechos de acceso; op.acc.7 – Gestión de privilegios
