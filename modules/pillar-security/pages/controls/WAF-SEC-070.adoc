...
|*ISO 27001:2022*
|A.8.8 – Management of technical vulnerabilities; A.8.19 – Installation of software on operational systems; A.8.32 – Change management

|*ISO 27017*
|CLD.12.1 – Operational procedures for cloud services

|*CIS Controls v8*
|CIS 7 – Continuous Vulnerability Management; CIS 2 – Inventory and Control of Software Assets

|*CSA STAR*
|CCM TVM-01 – Threat and Vulnerability Management Policy; CCM TVM-02 – Vulnerability Remediation Schedule

|*PCI DSS v4.0*
|Req 6 – Develop and maintain secure systems; Req 11.3 – Vulnerability scans

|*SOC 2 Type II*
|CC7.1 – System monitoring – vulnerability detection; CC8.1 – Change management

|*GDPR*
|Art. 32 – Security of processing

|*NIS2*
|Art. 21(2)(b) – Incident handling and vulnerability management

|*DORA*
|Art. 9 – Protection and prevention; Art. 17 – ICT-related testing

|*EUCS (ENISA)*
|OPS-04 – Vulnerability management; OPS-05 – Patch management

|*BSI C5:2020*
|OPS-18 – Vulnerability management; OPS-19 – Patch management; DEV-04 – Secure development – vulnerability handling

|*IT-Grundschutz*
|OPS.1.1.3 – Patch- und Änderungsmanagement; CON.8 – Software-Entwicklung

|*TISAX*
|Information security – Vulnerability and patch management

|*ANSSI SecNumCloud*
|Domain – Vulnerability management

|*BIO*
|BIO – Beheer van kwetsbaarheden

|*ENS High*
|op.exp.4 – Mantenimiento – actualizaciones de seguridad

|*UK Cyber Essentials*
|CE.PU – Patch management

|*UK NCSC CAF*
|B4.d – Vulnerability management

|*NIST SP 800-53*
|RA-5 – Vulnerability Monitoring and Scanning; SI-2 – Flaw Remediation; CM-8 – System Component Inventory

|*NIST CSF 2.0*
|ID.RA-01 – Vulnerabilities are identified; PR.PS-02 – Software is maintained, replaced and removed

|*FedRAMP*
|RA-5, SI-2, CM-8 (Moderate/High baseline)

|*HIPAA*
|§ 164.308(a)(1)(ii)(A) – Risk analysis; § 164.308(a)(8) – Evaluation

|*CMMC 2.0*
|RA.L2-3.11.2 – Scan for vulnerabilities; SI.L2-3.14.1 – Identify and correct flaws

|*ASD Essential 8*
|E8.1 – Application patching; E8.6 – Operating system patching

|*IRAP*
|ISM – Software and system management

|*CCCS PBMM*
|RA-5, SI-2 – Vulnerability scanning and flaw remediation

|*MAS TRM*
|Ch.7 – System development and change management; Ch.8 – IT operations – patching

|*ISMAP*
|Vulnerability and patch management

|*FISC*
|Technical measures – Vulnerability management
