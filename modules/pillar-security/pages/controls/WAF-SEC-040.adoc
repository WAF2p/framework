...
|*ISO 27001:2022*
|A.8.20 – Networks security; A.8.21 – Security of network services; A.8.24 – Use of cryptography
...
|*CIS Controls v8*
|CIS 3.10 – Encrypt sensitive data in transit; CIS 12.6 – Secure network communications

|*CSA STAR*
|CCM CEK-04 – Data in Transit Encryption; CCM IVS-03 – Network Security
...
|*EUCS (ENISA)*
|CKM-01 – Cryptographic policy; CSC-04 – Communications security

|*BSI C5:2020*
|CRY-01 – Use of cryptography; CRY-04 – Encryption of data in transit; COM-01 – Communications security

|*IT-Grundschutz*
|NET.3.3 – VPN; CON.1 – Kryptokonzept
...
|*ENS High*
|mp.com.2 – Protección de la confidencialidad; mp.com.3 – Protección de la autenticidad y de la integridad
...
|*NIST SP 800-53*
|SC-8 – Transmission Confidentiality and Integrity; SC-13 – Cryptographic Protection; SC-23 – Session Authenticity
