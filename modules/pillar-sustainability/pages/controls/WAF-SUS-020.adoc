...
|*Green Software Foundation*|Software Carbon Intensity (SCI) – hardware efficiency component; Energy Efficiency – compute selection guidance
|*EU CSRD (Corporate Sustainability Reporting Directive)*|ESRS E1 – Climate Change – Scope 3 emission reduction measures
|*GHG Protocol*|Scope 2 – Location-based and market-based methods; Scope 3 Category 11 – efficiency of purchased cloud compute
|*SBTi (Science Based Targets initiative)*|ICT Sector Guidance – energy intensity reduction targets; id: waf-sus-020.tf.aws.lambda-arm64; aws_lambda_function; id: waf-sus-020.tf.aws.ec2-no-previous-gen; aws_instance; aws_launch_template; id: waf-sus-020.tf.azurerm.vm-efficient-series; azurerm_linux_virtual_machine; azurerm_windows_virtual_machine
