...
|*Green Software Foundation*|Software Carbon Intensity (SCI) – measurement and optimization standard; Energy Efficiency – algorithmic and architectural efficiency; Carbon Efficiency – reducing energy per functional unit
|*EU CSRD (Corporate Sustainability Reporting Directive)*|ESRS E1 – Climate Change – operational measures to reduce emissions
|*ISO 14001*|6.1.2 – Environmental Aspects – software design as environmental aspect; id: waf-sus-070.tf.aws.lambda-no-large-layers; aws_lambda_function; id: waf-sus-070.tf.aws.sqs-not-polling; aws_lambda_event_source_mapping; id: waf-sus-070.tf.google.cloud-run-min-instances-zero; google_cloud_run_v2_service
