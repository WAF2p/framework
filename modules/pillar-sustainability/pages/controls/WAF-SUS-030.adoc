...
|*EU CSRD (Corporate Sustainability Reporting Directive)*|ESRS E1 – Climate Change – Scope 3 reduction actions
|*GHG Protocol*|Scope 2 – Market-based method (renewable energy certificates, PPAs); Scope 3 – Category 11: purchased cloud services location factor
|*Green Software Foundation*|Carbon Aware Computing – location-based optimization; Software Carbon Intensity (SCI) – location component
|*ISO 14001*|6.1.2 – Environmental aspects: procurement and infrastructure decisions; id: waf-sus-030.tf.aws.preferred-regions; aws; id: waf-sus-030.tf.google.preferred-regions; google; id: waf-sus-030.tf.azurerm.preferred-regions; azurerm_resource_group
