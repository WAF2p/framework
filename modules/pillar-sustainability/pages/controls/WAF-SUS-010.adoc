...
|*EU CSRD (Corporate Sustainability Reporting Directive)*|ESRS E1 – Climate Change; ESRS E1-6 – Gross Scope 1, 2, 3 GHG emissions
|*GHG Protocol*|Scope 3 – Category 11: Use of sold products; Scope 2 – Energy Indirect Emissions (location-based and market-based)
|*Green Software Foundation*|Software Carbon Intensity (SCI) – measurement standard
|*SBTi (Science Based Targets initiative)*|ICT Sector Guidance – Scope 3 measurement requirements
|*ISO 14001*|6.1.2 – Environmental Aspects identification and assessment; 9.1 – Monitoring, measurement, analysis and evaluation; id: waf-sus-010.tf.aws.cloudwatch-carbon-export; aws_cloudwatch_log_group; id: waf-sus-010.tf.aws.s3-carbon-export-lifecycle; aws_s3_bucket_lifecycle_configuration; id: waf-sus-010.tf.azurerm.log-analytics-retention; azurerm_log_analytics_workspace
