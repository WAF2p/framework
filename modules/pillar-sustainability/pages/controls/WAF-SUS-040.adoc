...
|*Green Software Foundation*|Hardware Efficiency – eliminate idle compute; Energy Efficiency – utilization-driven compute
|*EU CSRD (Corporate Sustainability Reporting Directive)*|ESRS E1 – Climate Change – resource efficiency measures
|*GHG Protocol*|Scope 3 Category 11 – reducing purchased cloud compute emissions
|*ISO 14001*|6.1.2 – Environmental Aspects – resource consumption reduction; 8.1 – Operational planning and control; id: waf-sus-040.tf.aws.autoscaling-enabled; aws_autoscaling_group; id: waf-sus-040.tf.aws.spot-instances-for-dev; aws_autoscaling_group; id: waf-sus-040.tf.google.managed-instance-group-autoscaler; google_compute_autoscaler
