...
|*Green Software Foundation*|Energy Efficiency – minimize network data transfer; Software Carbon Intensity (SCI) – network embodied energy
|*EU CSRD (Corporate Sustainability Reporting Directive)*|ESRS E1 – Climate Change – operational energy efficiency
|*GHG Protocol*|Scope 3 Category 11 – reducing network-related cloud emissions; id: waf-sus-080.tf.aws.cloudfront-compression; aws_cloudfront_distribution; id: waf-sus-080.tf.aws.vpc-endpoint-s3; aws_vpc_endpoint; id: waf-sus-080.tf.azurerm.cdn-compression; azurerm_cdn_endpoint
