...
|* FinOps Foundation* | Operate Phase – Architecture and Cost Governance; FinOps Principles – Everyone Takes Ownership of Their Cloud Usage
|* Internal Governance* | Architecture Governance – Economic Impact Documentation; Cloud Cost Governance Policy – Lock-in Assessment Requirement
...
|* FinOps Foundation* | Operate Phase – Architecture and Cost Governance; FinOps Principles – Everyone Takes Ownership of Their Cloud Usage
|* Internal Governance* | Architecture Governance – Economic Impact Documentation; Cloud Cost Governance Policy – Lock-in Assessment Requirement; id: waf-cost-050.tf.any.high-lockin-resource-tagged; aws_kinesis_stream; aws_kinesis_firehose_delivery_stream; aws_redshift_cluster; aws_neptune_cluster; aws_msk_cluster; azurerm_service_bus_namespace; azurerm_eventhub_namespace; azurerm_synapse_workspace; google_spanner_instance; google_bigquery_dataset; id: waf-cost-050.tf.any.adr-cost-section-present
