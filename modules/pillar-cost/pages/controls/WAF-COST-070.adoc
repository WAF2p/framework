...
|*GDPR*|Art. 5(1)(e) – Storage limitation (logs containing personal data must not be kept indefinitely)
|*FinOps Foundation*|Optimize Phase – Observability Cost Management
|*Internal Governance*|Retention Policy – Tiered Log Retention; Cloud Cost Governance – Observability Cost Target < 20% of Total
...
|*GDPR*|Art. 5(1)(e) – Storage limitation (logs containing personal data must not be kept indefinitely)
|*FinOps Foundation*|Optimize Phase – Observability Cost Management
|*Internal Governance*|Retention Policy – Tiered Log Retention; Cloud Cost Governance – Observability Cost Target < 20% of Total; id: waf-cost-070.tf.aws.cloudwatch-retention-not-infinite; aws_cloudwatch_log_group; id: waf-cost-070.tf.aws.cloudwatch-operational-retention-max-365; aws_cloudwatch_log_group
