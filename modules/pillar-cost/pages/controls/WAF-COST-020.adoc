...
|*FinOps Foundation*|Inform Phase – Budget Visibility and Accountability; Operate Phase – Budget Management and Variance Reporting
|*ISO 20000*|Service financial management – budget control
|*Internal Governance*|Cloud Cost Governance Policy – Budget Enforcement
...
|*FinOps Foundation*|Inform Phase – Budget Visibility and Accountability; Operate Phase – Budget Management and Variance Reporting
|*ISO 20000*|Service financial management – budget control
|*Internal Governance*|Cloud Cost Governance Policy – Budget Enforcement; id: waf-cost-020.tf.aws.budgets-budget-exists; aws_budgets_budget; id: waf-cost-020.tf.azurerm.consumption-budget-defined; azurerm_consumption_budget_resource_group; azurerm_consumption_budget_subscription; azurerm_consumption_budget_management_group
