...
|*FinOps Foundation*|Optimize Phase – Storage Optimization and Lifecycle Management
|*GDPR*|Art. 5(1)(e) – Storage limitation (data not kept longer than necessary); Art. 17 – Right to erasure (lifecycle policies support GDPR deletion requirements)
|*Internal Governance*|Data Retention Policy – Explicit lifecycle for all data categories; Cloud Cost Governance – No infinite retention defaults
...
|*FinOps Foundation*|Optimize Phase – Storage Optimization and Lifecycle Management
|*GDPR*|Art. 5(1)(e) – Storage limitation (data not kept longer than necessary); Art. 17 – Right to erasure (lifecycle policies support GDPR deletion requirements)
|*Internal Governance*|Data Retention Policy – Explicit lifecycle for all data categories; Cloud Cost Governance – No infinite retention defaults; id: waf-cost-040.tf.aws.s3-lifecycle-rule-defined; aws_s3_bucket_lifecycle_configuration; id: waf-cost-040.tf.aws.cloudwatch-log-retention-not-zero; aws_cloudwatch_log_group
