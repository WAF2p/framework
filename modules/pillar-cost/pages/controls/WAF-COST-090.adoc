...
|* FinOps Foundation* | Optimize Phase – Network Cost Optimization; Optimize Phase – Data Transfer Cost Reduction
|* Internal Governance* | Cloud Cost Governance Policy – Egress Cost Target; Network Architecture Standard – VPC Endpoints Mandatory
...
|* FinOps Foundation* | Optimize Phase – Network Cost Optimization; Optimize Phase – Data Transfer Cost Reduction
|* Internal Governance* | Cloud Cost Governance Policy – Egress Cost Target; Network Architecture Standard – VPC Endpoints Mandatory; id: waf-cost-090.tf.aws.vpc-endpoint-s3-exists; aws_vpc_endpoint; id: waf-cost-090.tf.aws.no-public-ip-internal-compute; aws_instance; aws_launch_template
