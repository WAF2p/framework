...
|*FinOps Foundation*|Inform Phase – Cost Allocation and Showback; Operate Phase – Tagging and Cost Attribution
|*ISO 20000*|Service financial management – cost allocation
|*Internal Governance*|Cloud Cost Governance Policy – Resource Ownership; FinOps Charter – Accountability and Transparency
...
|*FinOps Foundation*|Inform Phase – Cost Allocation and Showback; Operate Phase – Tagging and Cost Attribution
|*ISO 20000*|Service financial management – cost allocation
|*Internal Governance*|Cloud Cost Governance Policy – Resource Ownership; FinOps Charter – Accountability and Transparency; id: waf-cost-010.tf.aws.compute-mandatory-tags; aws_instance; aws_launch_template; aws_eks_node_group; aws_ecs_service; aws_lambda_function; aws_db_instance; aws_rds_cluster; aws_elasticache_cluster; aws_s3_bucket; aws_cloudwatch_log_group; id: waf-cost-010.tf.azurerm.resource-group-mandatory-tags; azurerm_resource_group; azurerm_virtual_machine; azurerm_storage_account; azurerm_sql_database; azurerm_kubernetes_cluster
