...
|*FinOps Foundation*|Optimize Phase – Rightsizing and Resource Optimization; Operate Phase – Continuous Resource Review
|*Internal Governance*|Cloud Cost Governance Policy – Resource Efficiency; Engineering Excellence – No Persistent Waste
...
|*FinOps Foundation*|Optimize Phase – Rightsizing and Resource Optimization; Operate Phase – Continuous Resource Review
|*Internal Governance*|Cloud Cost Governance Policy – Resource Efficiency; Engineering Excellence – No Persistent Waste; id: waf-cost-030.tf.aws.ec2-rightsizing-tag-required; aws_instance; aws_launch_template; id: waf-cost-030.tf.azurerm.vm-rightsizing-tag; azurerm_virtual_machine; azurerm_linux_virtual_machine; azurerm_windows_virtual_machine; azurerm_kubernetes_cluster
