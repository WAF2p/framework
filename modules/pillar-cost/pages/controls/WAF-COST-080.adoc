...
|* FinOps Foundation* | Optimize Phase – Rate Optimization and Commitment Management; Operate Phase – Commitment Planning and Renewal Management
|* Internal Governance* | Cloud Cost Governance Policy – Minimum Reserved Instance Coverage for Baseline Workloads
...
|* FinOps Foundation* | Optimize Phase – Rate Optimization and Commitment Management; Operate Phase – Commitment Planning and Renewal Management
|* Internal Governance* | Cloud Cost Governance Policy – Minimum Reserved Instance Coverage for Baseline Workloads; id: waf-cost-080.tf.aws.ec2-capacity-commitment-tag; aws_instance; aws_launch_template; id: waf-cost-080.tf.azurerm.vm-commitment-tag; azurerm_linux_virtual_machine; azurerm_windows_virtual_machine; azurerm_virtual_machine_scale_set
