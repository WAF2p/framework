...
|*AWS Well-Architected Framework*|Operational Excellence Pillar – OPS 6: How do you deploy your workload?
|*PCI DSS v4.0*|Requirement 6.5: Changes to all system components are managed securely; id: waf-ops-050.tf.aws.codepipeline-manual-approval; aws_codepipeline; id: waf-ops-050.tf.azurerm.devops-environment-approval; azuredevops_environment
