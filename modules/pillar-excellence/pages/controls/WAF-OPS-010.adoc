...
|*ISO/IEC 20000-1*|Change and deployment management; Release and deployment management
|*ITIL 4*|Change enablement; Deployment management
|*AWS Well-Architected Framework*|Operational Excellence Pillar – OPS 4: How do you implement observability in your workload?; Operational Excellence Pillar – OPS 6: How do you deploy your workload?
|*DevOps Research and Assessment (DORA)*|Deployment Frequency; Lead Time for Changes
|*CIS Controls v8*|CIS-4.1: Establish and Maintain a Secure Configuration Process; id: waf-ops-010.tf.aws.codepipeline-exists; aws_codepipeline; id: waf-ops-010.tf.azurerm.devops-pipeline-exists; azuredevops_build_definition; id: waf-ops-010.tf.google.cloudbuild-trigger-exists; google_cloudbuild_trigger
