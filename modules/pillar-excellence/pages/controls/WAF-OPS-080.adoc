...
|*DevOps Research and Assessment (DORA)*|Change Failure Rate; Mean Time to Restore
|*AWS Well-Architected Framework*|Operational Excellence Pillar – OPS 6: How do you deploy your workload?
|*ITIL 4*|Release management; Change enablement
|*ISO/IEC 20000-1*|Change and deployment management; id: waf-ops-080.tf.aws.codedeploy-deployment-config; aws_codedeploy_deployment_group; id: waf-ops-080.tf.aws.appconfig-feature-flag; aws_appconfig_application; id: waf-ops-080.tf.azurerm.traffic-manager-canary; azurerm_traffic_manager_profile
