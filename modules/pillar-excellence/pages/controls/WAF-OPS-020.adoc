...
|* ISO/IEC 20000-1* | Configuration management; Change and deployment management
|* ITIL 4* | Infrastructure and platform management; Configuration management
|* AWS Well-Architected Framework* | Operational Excellence Pillar – OPS 5: How do you reduce defects, ease remediation, and improve flow in your workload?
|* DevOps Research and Assessment (DORA)* | Version Control; Infrastructure as Code
|* CIS Controls v8* | CIS-4.6: Securely Manage Enterprise Assets and Software; id: waf-ops-020.tf.aws.s3-terraform-state-backend; id: waf-ops-020.tf.aws.s3-state-bucket-versioning; aws_s3_bucket_versioning; id: waf-ops-020.tf.azurerm.terraform-state-storage; azurerm_storage_account
