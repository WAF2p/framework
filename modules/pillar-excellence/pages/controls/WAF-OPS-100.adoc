...
|*ISO/IEC 20000-1*|Continual improvement; Risk management
|*ITIL 4*|Continual improvement; Problem management
|*Google SRE Book*|Chapter 5: Eliminating Toil
|*AWS Well-Architected Framework*|Operational Excellence Pillar – OPS 10: How do you use findings to take action?; id: waf-ops-100.tf.aws.eventbridge-ops-review-schedule; aws_cloudwatch_event_rule; id: waf-ops-100.tf.aws.ssm-automation-runbook; name: TerminateInstances; aws_ssm_document
