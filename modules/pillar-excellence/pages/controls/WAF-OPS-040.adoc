...
|*ISO/IEC 20000-1*|Incident management; Monitoring, measurement, analysis, and evaluation
|*ITIL 4*|Monitoring and event management; Incident management
|*AWS Well-Architected Framework*|Operational Excellence Pillar – OPS 8: How do you understand the health of your operations?
|*Google SRE Book*|Chapter 6: Monitoring Distributed Systems – Four Golden Signals; Chapter 5: Eliminating Toil; id: waf-ops-040.tf.aws.cloudwatch-alarm-symptom-based; aws_cloudwatch_metric_alarm; id: waf-ops-040.tf.azurerm.monitor-alert-symptom; azurerm_monitor_metric_alert; id: waf-ops-040.tf.google.monitoring-alert-symptom; google_monitoring_alert_policy
