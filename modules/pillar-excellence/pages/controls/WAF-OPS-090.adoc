...
|*ISO/IEC 20000-1*|Configuration management
|*ITIL 4*|Service configuration management
|*SOC 2 Type II*|CC8.1 – Change Management – Authorized Changes
|*PCI DSS v4.0*|Requirement 12.3.2: Perform targeted risk analyses
|*BSI C5:2020*|BCM-04 Configuration Management; id: waf-ops-090.tf.aws.config-rule-enabled; aws_config_configuration_recorder; id: waf-ops-090.tf.aws.cloudtrail-enabled; aws_cloudtrail; id: waf-ops-090.tf.azurerm.policy-assignment-drift; azurerm_subscription_policy_assignment
