...
|*ISO/IEC 20000-1*|Incident management; Continual improvement
|*ITIL 4*|Problem management; Continual improvement
|*AWS Well-Architected Framework*|Operational Excellence Pillar – OPS 9: How do you understand how your operations are performing?
|*Google SRE Book*|Chapter 15: Postmortem Culture: Learning from Failure
|*SOC 2 Type II*|CC9.2 – Risk Assessment and Communication; id: waf-ops-070.tf.aws.incident-management-sns-topic; aws_sns_topic; id: waf-ops-070.tf.azurerm.action-group-incident; azurerm_monitor_action_group
