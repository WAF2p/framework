...
|* AWS Well-Architected Framework* | OPS 11 – Respond to events
|* BSI C5:2022* | IS-09 – Incident Management
|* GDPR* | Article 33 – Notification of a personal data breach to the supervisory authority; id: waf-rel-060.tf.aws.sns-topic-alarm-action; aws_cloudwatch_metric_alarm; id: waf-rel-060.tf.azurerm.action-group-configured; azurerm_monitor_action_group; id: waf-rel-060.tf.google.monitoring-notification-channel; google_monitoring_alert_policy
