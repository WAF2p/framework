...
|*ISO/IEC 27001:2022*|A.15.1 – Information security in supplier relationships; A.17.1 – Information security continuity
|*AWS Well-Architected Framework*|REL 4 – Manage dependencies
|*ITIL 4*|Supplier Management; Service Configuration Management
|*NIST SP 800-161*|Supply Chain Risk Management; id: waf-rel-080.tf.aws.vpc-endpoint-dependency-isolation; aws_vpc_endpoint; id: waf-rel-080.tf.azurerm.private-endpoint-dependency; azurerm_private_endpoint; id: waf-rel-080.tf.google.vpc-sc-dependency-isolation; google_compute_subnetwork
