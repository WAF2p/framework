...
|*ISO/IEC 27001:2022*|A.17.1.3 – Verify, review and evaluate information security continuity
|*GDPR*|Article 32 – Security of processing (resilience and recovery testing)
|*BSI C5:2022*|RB-04 – Data Backup and Recovery; RB-05 – Disaster Recovery
|*AWS Well-Architected Framework*|REL 14 – Plan for disaster recovery; REL 13 – Test resiliency
|*ITIL 4*|Service Continuity Management; id: waf-rel-070.tf.aws.route53-health-check-failover; aws_route53_health_check; id: waf-rel-070.tf.azurerm.traffic-manager-profile; azurerm_traffic_manager_profile; id: waf-rel-070.tf.google.dns-managed-zone-failover; google_dns_record_set
