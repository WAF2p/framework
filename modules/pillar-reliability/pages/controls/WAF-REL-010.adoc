...
|*ITIL 4*|Service Level Management; Service Continuity Management
|*AWS Well-Architected Framework*|REL 1 – Manage service quotas and constraints; REL 10 – Use fault isolation to protect your workload
|*SRE Book (Google)*|Chapter 4 – Service Level Objectives; Chapter 5 – Eliminating Toil; id: waf-rel-010.tf.aws.cloudwatch-slo-alarm; aws_cloudwatch_metric_alarm; id: waf-rel-010.tf.azurerm.monitor-metric-alert-slo; azurerm_monitor_metric_alert; id: waf-rel-010.tf.google.monitoring-alert-policy-slo; google_monitoring_alert_policy
